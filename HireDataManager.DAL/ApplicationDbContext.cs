...
public partial class ApplicationDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CountryId).HasName("PK__countrie__7E8CD055E8D59E96");
        ...
        {
            entity.HasKey(e => e.DepartmentId).HasName("PK__departme__C223242246907EC2");
        ...
        {
            entity.HasKey(e => e.DependentId).HasName("PK__dependen__F25E28CE36F92B84");
        ...
        {
            entity.HasKey(e => e.EmployeeId).HasName("PK__employee__C52E0BA845A3BB7C");
        ...
        {
            entity.HasKey(e => e.JobId).HasName("PK__jobs__6E32B6A558B88E7A");
        ...
        {
            entity.HasKey(e => e.LocationId).HasName("PK__location__771831EAF16F2A10");
        ...
        {
            entity.HasKey(e => e.RegionId).HasName("PK__regions__01146BAE667A44E9");
